        ...
        <div className="main row">
            ...
            <div className="col-9 mx-auto">
                <div className="row">
                    ...
                    <div className="col-5 mx-auto">
                        <p style={{fontSize:"110%;"}}><img className="img-fluid" src={kevinPaint} alt="I married this man later" style={{ float: "right;", width: "325px;", height: "452px;", margin: "0px 0px 0px 30px;" }} />
                        </p>
                    </div>
                </div>
            </div>
            <p>&nbsp;</p>
            <div className="col-10 mx-auto">
                <h2>REFERENCES</h2><p style={{fontSize:"110%;"}}><strong>References for my research work:</strong></p>
            </div>
            <div className="col-9 mx-auto">     
                <div className="row">
